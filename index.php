...
//Controle bij herladen pagina op foutboodschap via get flag
  ...
  <body>
        ...
        <div class="cell shrink header medium-cell-block-container">
          ...
          <div class="clearfix">
            <div class="button-group float-right">
              <a id="btn_koppel" class="success button">Koppel
              </a>
            </div>
          </div>
            ...
            <div class="cell medium-4 medium-cell-block-y">
              <ul class="accordion" data-accordion data-allow-all-closed="true" data-multi-expand="true">
                <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Mechanische data
                  </a>
                      ...
                      <div class="grid-container">
                        <div class="grid-x grid-padding-x">
                          <div class="medium-12 cell">
                            <label>Settings:
                              <select name="settings" id="md_settings">
                                <option value="0">Maak/Selecteer setting
                                </option>
                                <?php 
                          ...
                          <div class="md_new_block medium-12 cell">
                            <p>Maak hier een nieuwe setting.
                            </p>
                          </div>
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Afwijking ten opzichte van lengte-as">Toe (mm):
                              </span>
                          ...
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Afwijking ten opzichte van verticale lijn">Camber (°):
                              </span>
                          ...
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Hoogte van chassis tegenover grond">Hoogte (mm):
                              </span>
                          ...
                          <div class="md_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Gebruikte bandensoort">Bandentype:
                              </span>
                              <select name="banden" required>
                                <option value="C17 slick">C17 slick
                                </option>
                                <option value="C17 wet">C17 wet
                                </option>
                              </select>
                            </label>
                          </div>
                          <div class="md_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Hoeveelheid bandendruk in bar">Bandendruk (bar):
                              </span>
                          ...
                          <div class="md_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Type veer gebruikt in schokdempers">Veer:
                              </span>
                              <select name="veer" required>
                                <option value="36mm soft">36mm Soft
                                </option>
                                <option value="36mm hard">36mm Hard
                                </option>
                              </select>
                            </label>
                          </div>
                          <div class="md_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Type torsieveer">Torsieveer:
                              </span>
                              <select name="torsieveer" required>
                                <option value="torsieveer 1">torsieveer 1
                                </option>
                                <option value="torsieveer 2">torsieveer 2
                                </option>
                              </select>
                            </label>
                          </div>    
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Links/Rechts High speed bump kliks">LR HSB:
                              </span>
                          ...
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Links/Rechts Low speed bump kliks">LR LSB:
                              </span>
                          ...
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Links/Rechts rebound kliks">LR R:
                              </span>
                          ...
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Midden High speed bump kliks">M HSB:
                              </span>
                          ...
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Midden Low speed bump kliks">M LSB:
                              </span>
                          ...
                          <div class="md_new_block medium-4 cell">
                            <label>
                              <span data-tooltip class="top" title="Midden rebound kliks">M R:
                              </span>
                              <input name="M_R" type="number" min="1" max="18" value="9" step="1" required>
                            </label>
                          </div>
                          <div class="md_new_block medium-12 cell">
                            <button name="btn_md" type="button submit" class="button float-right">Save
                            </button>
                          </div>
                        </div>
                      </div>
                ...
                <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Circuit data
                  </a>
                  <div class="accordion-content" data-tab-content>
                      ...
                      <div class="grid-container">
                        <div class="grid-x grid-padding-x">
                          ...
                          <div class="cd_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Locatie van circuit">Naam (locatie):
                              </span>
                          ...
                          <div class="cd_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Gebruikte ondergrond">Weg type:
                              </span>
                              <select name="wegtype">
                                <option value="Asfalt">Asfalt
                                </option>
                          ...
                          <div class="cd_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Staat van het wegdek">Ondergrond:
                              </span>
                              <select name="ondergrond">
                                <option value="Droog">Droog
                                </option>
                          ...
                          <div class="cd_new_block medium-6 cell">
                            <label>
                              <span data-tooltip class="top" title="Soort dynamisch event">Type event:
                              </span>
                              <select name="typeEvent">
                                <option value="Acceleratie">Acceleratie
                                </option>
                                <option value="SkidPad">Skid Pad
                                </option>
                              </select>
                            </label>
                          </div>
                          <div class="cd_new_block medium-12 cell">
                            <button name="btn_cd" type="button submit" class="button float-right">Save
                            </button>
                          </div>
                        </div>
                      </div>
                ...
                <li class="accordion-item" data-accordion-item>
                  <a href="#" class="accordion-title">Weer data (API)
                  </a>
                  <div class="accordion-content" data-tab-content>
                      ...
                      <div class="grid-container">
                        <div class="grid-x grid-padding-x">
                          ...
                          <div class="wd_new_block medium-2 cell search">
                            <button id="search-btn" type="button" class="button float-right">
                          ...
                          <div class="wd_new_block medium-12 cell">
                            <button name="btn_wd" type="button submit" class="button float-right">Save
                            </button>
                          </div>
                        </div>
                      </div>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        var selected = [];
        //Sensordata inladen van telemetrie databank via server processing
        $('#sensortabel').DataTable( {
          ...
          //In geval van connectie fout met DataTables, opvangen en melden
          $vlag = 5;
        ...
        function cal_avg(lengte, data) {
          /**
                * Berekent op de geselecteerde data uit de tabel het gemiddelde
                * Houdt eveneens rekening met negatieve, en foute data
                * @param lengte, de lengte van de data array
                * @param data, de data in array vorm
                * @return gemiddelde
                */
          var avg = 0;
          var nl = lengte;
          ...
          if(isNaN(avg)) {
            ...
            var avg_r = Math.round(avg*1000)/1000;
            //afronden op 3 na komma
            return avg_r;
          }
        }
        //Als de gebruiker de data wil koppelen
        $("#btn_koppel").click(function(){
          ...
          if ( $md_val == 0 || $cd_val == 0 || $wd_val == 0  ) {
            ...
            var myObj = {
              "md_val": $md_val, "cd_val": $cd_val, "wd_val": $wd_val};
            ...
            var typearray = [];
            var timearray = [];
            //Per geselecteerde rij type en tijd toevoegen aan array
            ...
            var totaalTijd = (eindTijd.getTime() - beginTijd.getTime())/1000;
            //tijd in seconden
        ...
        //Meldingen automatisch sluiten na 10s
        $('.callout').closest('[data-alert]').delay(10000).fadeOut(1000);
        //Interactieve interface verbergen en tonen
