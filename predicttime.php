        ...
        <div class="cell medium-auto medium-cell-block-container">
          <div class="grid-x grid-padding-x">
            ...
            <div class="cell medium-6 medium-cell-block-y">
              ...
              <p class="help-text" ic="exampleHelpText">Alle invoervelden zijn verplicht in te vullen!
              </p>
              <hr>
                ...
                <div class="grid-x grid-margin-x">
                  ...
                  <div class="cell medium-2">
                    <label for="toespoor" class="text-left middle">
                      <span data-tooltip class="top" title="De hoeveelheid toespoor waarop je voorspelling wil baseren">Toe:
                      </span>
                    </label>
                  </div>
                  <div class="cell medium-4">
                ...
                <div class="grid-x grid-margin-x">
                  <div class="cell medium-2">
                    <label for="camber" class="text-left middle">
                      <span data-tooltip class="top" title="De hoeveelheid camber waarop je voorspelling wil baseren">Camber:
                      </span>
                    </label>
                  </div>
                  <div class="cell medium-4">
                  ...
                  <div class="cell medium-2">
                    <label for="bandendruk" class="text-left middle">
                      <span data-tooltip class="top" title="De hoeveelheid bandendruk waarop je voorspelling wil baseren">Bandendruk:
                      </span>
                    </label>
                  </div>
                  <div class="cell medium-4">
                ...
                <div class="grid-x grid-margin-x">
                  <div class="cell medium-2">
                    <label for="hoogte" class="text-left middle">
                      <span data-tooltip class="top" title="De hoeveelheid hoogte waarop je voorspelling wil baseren">Hoogte:
                      </span>
                    </label>
                  </div>
                  <div class="cell medium-4">
